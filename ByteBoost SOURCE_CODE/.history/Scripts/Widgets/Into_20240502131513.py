...
class DateTimeFrame():
    ...
    def create_widgets(self, parent):
        self.day_label = ctk.CTkLabel(parent, text_color=font_color, font=("JetBrains Mono", 95))
        self.day_label.place(relx=0.07, rely=0.01, anchor="nw")

        self.weekday_label = ctk.CTkLabel(parent, text_color=font_color, font=("JetBrains Mono", 20))
        self.weekday_label.place(relx=0.5, rely=0.12)

        self.time_label = ctk.CTkLabel(parent, text_color=font_color, font=('JetBrains Mono', 35))
...
class QuotesFrame():
    ...
    def create_widgets(self, parent):
        title_label = ctk.CTkLabel(parent, text_color=font_color, text="Dijkstra's Law", font=("Poppins", 20))
        title_label.place(relx=0.07, rely=0.5)

        quote_label = ctk.CTkLabel(parent, text_color=font_color, text="Picking up a new game is like learning a new language: you fumble with the controls and hope you don't embarrass yourself in front of NPCs", justify="left", font=("Poppins", 12), wraplength=250)
