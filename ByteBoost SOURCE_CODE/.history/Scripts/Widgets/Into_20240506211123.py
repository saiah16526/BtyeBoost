...
class QuotesFrame():
    ...
    def create_widgets(self, parent):
        ...
        def load_quote():
            with open(resource_path('.\\SaveFiles\\law.json'), "r") as file:
                ...
                title_label.configure(text=selected_sub_category)
                quote_label.configure(text=(laws_dict[selected_category][selected_sub_category]))
