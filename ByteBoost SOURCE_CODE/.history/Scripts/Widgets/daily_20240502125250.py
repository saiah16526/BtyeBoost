...
class DailyProgressApp:
    ...
    def create_widgets(self):
        ...
        frame = ProgressFrame(self.master, border_color=border_color, border_width=border_width, corner_radius=2, fg_color=Daily_background)
        ...
        label_configs = [
            {"style": {'text': 'DAILY....', 'font': ('JetBrains Mono', 50)}, 'place': {'x': 10, 'rely': 0.077, 'relheight': 0.15, 'anchor': 'nw'}},
            {"style":{'text': 'Conquests and Endeavors Progress', 'font': ('Ubuntu-Title', 18)}, 'place': {'x': 10, 'rely': 0.23, 'relheight': 0.12, 'anchor': 'nw'}},
            {"style":{'text': '4', 'font': ('JetBrains Mono', 97)}, 'place': {'relx': 0.02, 'rely': 0.38, 'anchor': 'nw'}},
            {"style":{'text': '9', 'font': ('JetBrains Mono', 37)}, 'place': {'relx': 0.25, 'rely': 0.68, 'relheight': 0.15, 'anchor': 'nw'}},
            {"style":{'text': 'In Progress...', 'font': ('unionagrochem', 17, 'bold')}, 'place': {'relx': 0.02, 'rely': 0.85, 'relheight': 0.15, 'anchor': 'nw'}},
            {"style":{'text': '79%', 'font': ('JetBrains Mono', 50)}, 'place': {'relx': 0.55, 'rely': 0.52, 'anchor': 'nw'}}
        ]

        # Add labels to display daily progress information
        for config in label_configs:
            ctk.CTkLabel(frame,text_color=border, **config["style"]).place(**config["place"])  # Create and place labels with specified configurations
