...
class DailyProgressApp:
    ...
    def create_widgets(self):
        ...
        label_configs = [
            {"style": {'text': 'DAILY....', 'font': (font_family, 50)}, 'place': {'x': 10, 'rely': 0.077, 'relheight': 0.15, 'anchor': 'nw'}},
            {"style":{'text': 'Conquests and Endeavors Progress', 'font': ('Ubuntu-Title', 18)}, 'place': {'x': 10, 'rely': 0.23, 'relheight': 0.12, 'anchor': 'nw'}},
            {"style":{'text': '4', 'font': (font_family, 97)}, 'place': {'relx': 0.02, 'rely': 0.38, 'anchor': 'nw'}},
            {"style":{'text': '9', 'font': (font_family, 37)}, 'place': {'relx': 0.25, 'rely': 0.68, 'relheight': 0.15, 'anchor': 'nw'}},
            {"style":{'text': 'In Progress...', 'font': ('unionagrochem', 17, 'bold')}, 'place': {'relx': 0.02, 'rely': 0.85, 'relheight': 0.15, 'anchor': 'nw'}},
            {"style":{'text': '79%', 'font': (font_family, 50)}, 'place': {'relx': 0.55, 'rely': 0.52, 'anchor': 'nw'}}
        ]
