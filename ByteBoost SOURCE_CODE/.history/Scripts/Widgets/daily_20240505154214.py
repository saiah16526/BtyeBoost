...
class ProgressCanvas(ctk.CTkCanvas):
    ...
    def draw_progress_meter(self):
        ...
        self.create_arc(
            ...
            outline=BACKGROUND  # Background color of the canvas
        )
        ...
        self.create_oval(
            ...
            outline=BACKGROUND  # Background color (no visible outline)
        )

class DailyProgressApp:
    def __init__(self, master):
        self.master = master
        self.frame = ProgressFrame(self.master, border_color=BORDER_COLOR, border_width=BORDER_WIDTH, corner_radius=BORDER_RADIUS, fg_color=BACKGROUND)
    ...
    def create_widgets(self):
        ...
        canvas_progress = self.frame.create_canvas(background=BACKGROUND, bd=0, highlightthickness=0)
