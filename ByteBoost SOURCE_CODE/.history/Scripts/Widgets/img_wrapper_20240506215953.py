...
class ImgWrapper(ctk.CTkFrame):
    def __init__(self, master):
        ...
        canvas.create_text(10, 315, anchor="nw", justify="left", text="Image Crawller", fill=self.SETTINGS["BORDER_COLOR"], font=("Poppins", 20))
        canvas.create_text(10, 350, anchor="nw", justify="left", text="Coming Soon !!!", fill=self.SETTINGS["BORDER_COLOR"], font=("Poppins", 10))
