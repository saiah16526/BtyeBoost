...
class Statistics(ctk.CTkScrollableFrame):
    ...
    def create_date_stats(self):
        ...
        self.date = ctk.CTkLabel(date_frame, text="DATE: 4, OCTOBER 2004", font=(font_family[0], 13))
        self.date.pack(side="left", expand=True)
        self.target = ctk.CTkLabel(date_frame, text="DAILY CHALLENGE: 100%", font=(font_family[0], 13))
