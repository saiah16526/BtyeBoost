...
class Statistics(ctk.CTkScrollableFrame):
    ...
    def create_date_stats(self):
        ...
        self.name_frame = ctk.CTkFrame(frame, fg_color="red", width=100)
        self.category_frame = ctk.CTkFrame(frame, fg_color="blue", width=60)
        self.from_frame = ctk.CTkFrame(frame, fg_color="pink")
        self.to_frame = ctk.CTkFrame(frame, fg_color="red")
