...
class Statistics(ctk.CTkScrollableFrame):
    ...
    def create_date_stats(self):
        ...
        self.category_frame = ctk.CTkFrame(frame, fg_color="blue", width=130)
        self.from_frame = ctk.CTkFrame(frame, fg_color="pink", width=80)
        self.to_frame = ctk.CTkFrame(frame, fg_color="red", width=80)
