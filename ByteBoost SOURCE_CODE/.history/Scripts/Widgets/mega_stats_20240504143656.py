...
class Statistics(ctk.CTkScrollableFrame):
    ...
    def create_date_stats(self):
        ...
        self.name_frame = ctk.CTkFrame(frame,corner_radius=0, fg_color="red", width=160)
        self.category_frame = ctk.CTkFrame(frame,corner_radius=0, fg_color="blue", width=130)
        self.from_frame = ctk.CTkFrame(frame,corner_radius=0, fg_color="pink", width=80)
        self.to_frame = ctk.CTkFrame(frame,corner_radius=0, fg_color="red", width=80)
        self.duration_frame = ctk.CTkFrame(frame,corner_radius=0, fg_color="white")
        ...
        ctk.CTkLabel(self.name_frame, text="LESSON", font=(font_family[0], 13)).pack(fill="x")
        ctk.CTkLabel(self.category_frame, text="CATEGORY", font=(font_family[0], 13)).pack(fill="x")
        ctk.CTkLabel(self.from_frame, text="FROM", font=(font_family[0], 13)).pack(fill="x")
        ctk.CTkLabel(self.to_frame, text="TO", font=(font_family[0], 13)).pack(fill="x")
        ctk.CTkLabel(self.duration_frame, text="DURATION", font=(font_family[0], 13)).pack(fill="x")
