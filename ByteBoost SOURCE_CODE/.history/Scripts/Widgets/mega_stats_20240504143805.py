...
class Statistics(ctk.CTkScrollableFrame):
    ...
    def create_date_stats(self):
        ...
        self.name_frame.pack(side="left", expand=True, fill="y", expand=True)
        self.category_frame.pack(side="left", expand=True, fill="y", expand=True)
        self.from_frame.pack(side="left", expand=True, fill="y", expand=True)
        self.to_frame.pack(side="left", expand=True, fill="y", expand=True)
        self.duration_frame.pack(side="left", expand=True, fill="y", expand=True)
