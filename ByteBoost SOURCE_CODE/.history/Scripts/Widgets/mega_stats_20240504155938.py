...
class Statistics(ctk.CTkScrollableFrame):
    ...
    def create_date_stats(self, date, details):
        ...
        ctk.CTkLabel(self.name_frame,text_color="#201" ,fg_color=font_color,text="LESSON", font=(font_family[0], 13)).pack(padx=1,fill="x", expand=True)
        ctk.CTkLabel(self.category_frame,text_color="#201" ,fg_color=font_color,text="CATEGORY", font=(font_family[0], 13)).pack(padx=1,fill="x", expand=True)
        ctk.CTkLabel(self.from_frame,text_color="#201" ,fg_color=font_color,text="FROM", font=(font_family[0], 13)).pack(padx=1,fill="x", expand=True)
        ctk.CTkLabel(self.to_frame,text_color="#201" ,fg_color=font_color,text="TO", font=(font_family[0], 13)).pack(padx=1,fill="x", expand=True)
        ctk.CTkLabel(self.duration_frame,text_color="#201" ,fg_color=font_color,text="DURATION", font=(font_family[0], 13)).pack(padx=1,fill="x", expand=True)
    ...
    def update_stats(self, name, category, start, to, duration, color):
        ctk.CTkLabel(fg_color=color,master=self.name_frame, text=name, font=(font_family[0], 13)).pack(fill="x", expand=True, padx=1)
        ctk.CTkLabel(fg_color=color,master=self.category_frame, text=category, font=(font_family[0], 13)).pack(fill="x", expand=True, padx=1)
        ctk.CTkLabel(fg_color=color,master=self.from_frame, text=start, font=(font_family[0], 13)).pack(fill="x", expand=True, padx=1)
        ctk.CTkLabel(fg_color=color,master=self.to_frame, text=to, font=(font_family[0], 13)).pack(fill="x", expand=True, padx=1)
        ctk.CTkLabel(fg_color=color,master=self.duration_frame, text=duration, font=(font_family[0], 13)).pack(fill="x", expand=True, padx=1)
