...
class Statistics(ctk.CTkScrollableFrame):
    ...
    def create_date_stats(self, date, details):
        ...
        self.category_frame.pack(side="left", fill="both")
        self.from_frame.pack(side="left", fill="both")
        self.to_frame.pack(side="left", fill="both")
        self.duration_frame.pack(side="left", fill="both")
