...
class Statistics(ctk.CTkScrollableFrame):
    ...
    def create_date_stats(self, date, details):
        ...
        self.name_frame.pack_propagate(flag=True)
        self.category_frame.pack_propagate(flag=True)
        self.from_frame.pack_propagate(flag=True)
        self.to_frame.pack_propagate(flag=True)
        self.duration_frame.pack_propagate(flag=True)
