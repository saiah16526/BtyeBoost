...
class Statistics(ctk.CTkScrollableFrame):
    ...
    def create_date_stats(self, date, details):
        ...
        self.name_frame.pack(fill="x",side="left")
        self.category_frame.pack(fill="x",side="left")
        self.from_frame.pack(fill="x",side="left")
        self.to_frame.pack(fill="x",side="left")
        self.duration_frame.pack(fill="x",side="left")
