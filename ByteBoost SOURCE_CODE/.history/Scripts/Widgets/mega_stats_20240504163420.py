...
class Statistics(ctk.CTkScrollableFrame):
    ...
    def create_date_stats(self, date, details):
        ...
        test = ctk.CTkLabel(self.name_frame,width=160, text_color="#201" ,fg_color=font_color,text="LESSON", font=(font_family[0], 13))
        test.pack(padx=1,fill="x")
