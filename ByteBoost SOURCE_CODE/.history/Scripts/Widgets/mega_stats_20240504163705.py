...
class Statistics(ctk.CTkScrollableFrame):
    ...
    def create_date_stats(self, date, details):
        ...
        label_2 = ctk.CTkLabel(self.category_frame,text_color="#201" ,fg_color=font_color,text="CATEGORY", font=(font_family[0], 13), width=120)
        label_2.pack(padx=1,fill="x")
        label_3 = ctk.CTkLabel(self.from_frame,text_color="#201" ,fg_color=font_color,text="FROM", font=(font_family[0], 13), width=80)
        label_3.pack(padx=1,fill="x")
        label_4 = ctk.CTkLabel(self.to_frame,text_color="#201" ,fg_color=font_color,text="TO", font=(font_family[0], 13), width=80)
        label_4.pack(padx=1,fill="x")
        label_5 = ctk.CTkLabel(self.duration_frame,text_color="#201" ,fg_color=font_color,text="DURATION", font=(font_family[0], 13))
