...
class Statistics(ctk.CTkScrollableFrame):
    def __init__(self, master):
        ...
        close_img = ImageTk.PhotoImage(Image.open("./Images/Icons/cancel.png").resize((30, 30)))
        self.close_btn = ctk.CTkButton(master,fg_color="transparent" ,text="",image=close_img,corner_radius=0, font=(font_family[0], 13), command=lambda: close_panel(self))
