...
class Statistics(ctk.CTkScrollableFrame):
    def __init__(self, master):
        ...
        self.close_btn = ctk.CTkButton(master,fg_color=border_color ,height=20,text="",image=close_img,corner_radius=8, font=(font_family[0], 13), command=lambda: close_panel(self))
        
    def show_panel(self):
        self.close_btn.place(relx=0.83, rely=0.18, relwidth=0.042)
