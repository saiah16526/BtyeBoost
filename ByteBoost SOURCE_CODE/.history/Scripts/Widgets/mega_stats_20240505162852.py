...
class Statistics(ctk.CTkScrollableFrame):
    def __init__(self, master):
        ...
        self.close_btn = ctk.CTkButton(master,fg_color=self.SETTINGS["BORDER_COLOR"] ,height=10,text="",image=close_img,corner_radius=3, font=(FONT_FAMILY[0], 13), command=lambda: close_panel(self))
    ...
    def create_date_stats(self, date, details):
        ...
        color_cycle = itertools.cycle([self.SETTINGS["BACKGROUND"], "#112"])
