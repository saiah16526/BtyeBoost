...
class StatsWrapper(ctk.CTkFrame):
    def __init__(self, master, stats_background=Stats_background, border="#88aa77"):
        ...
        ctk.CTkButton(frame, text="", image=reset_img, fg_color=self.stats_background, hover_color=self.stats_background,corner_radius=0,width=40, height=10, command=self.toggle_stats_view).pack(side="left", expand=False, fill="both")
