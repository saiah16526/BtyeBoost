...
class StatsWrapper(ctk.CTkFrame):
    ...
    def draw_language_bar(self, canvas, text, percentage, y_increment):
        ...
        self.draw_rectangle(canvas, x + 10, y + 3.5, current_x, y + 10.5, fill=progress_bar_theme)
        # Display the percentage value next to the progress bar
        self.draw_text(canvas, current_x + 35, y, f"{int(percentage)}%", font=(font_family[0], 9, 'bold'), anchor="ne", fill=progress_bar_theme)
