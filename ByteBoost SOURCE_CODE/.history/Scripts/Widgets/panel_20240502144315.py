...
class Panel:
        def __init__(self, master):
            ...
            self.settings_button = ctk.CTkButton(self.frame, text="", corner_radius=5, command=self.toggle_panel_view)
        ...
        def update_panel_layout(self):
            if self.is_collapsed:
                ...
                self.settings_button.place(relx=0.01, rely=0.01, anchor="nw", relwidth=0.1)
