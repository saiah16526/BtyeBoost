...
class Panel:
        def __init__(self, master):
            ...
            self.settings_button = ctk.CTkButton(self.frame, text="SETTINGS",font=(font_family[0], 13),width=10, corner_radius=5, command=self.toggle_panel_view)
