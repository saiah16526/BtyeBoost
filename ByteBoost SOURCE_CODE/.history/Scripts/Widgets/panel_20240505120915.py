...
class Panel(ctk.CTkFrame):
        def __init__(self, master):
            ...
            #image
            expand_img = ImageTk.PhotoImage(Image.open("./Images/Icons/reset.png").resize((50, 50)))
            settings_img = ImageTk.PhotoImage(Image.open("./Images/Icons/reset.png").resize((50, 50)))
            
            self.toggle_button = ctk.CTkButton(self, text="",image=expand_img ,corner_radius=5, command=self.toggle_panel_view)
