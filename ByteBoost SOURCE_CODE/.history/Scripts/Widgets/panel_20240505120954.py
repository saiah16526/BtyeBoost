...
class Panel(ctk.CTkFrame):
        def __init__(self, master):
            ...
            #image
            expand_img = ImageTk.PhotoImage(Image.open("./Images/Icons/expand.png").resize((50, 50)))
            ...
            self.place(relx=0, rely=0, relwidth=0.04, relheight=1, anchor="nw")
        ...
        def update_panel_layout(self):
            if self.is_collapsed:
                ...
                self.toggle_button.place(relx=0.04, rely=0.01, anchor="nw", relwidth=0.9)
