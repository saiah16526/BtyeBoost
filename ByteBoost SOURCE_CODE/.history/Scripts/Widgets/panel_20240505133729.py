...
class Panel(ctk.CTkFrame):
        def __init__(self, master):
            ...
            self.toggle_button = ctk.CTkButton(self,fg_color=PANEL_BACKGROUND, hover_color=PANEL_BACKGROUND, text="",image=self.expand_img ,corner_radius=5, command=self.toggle_panel_view)
            self.settings_button = ctk.CTkButton(self, text="",fg_color=PANEL_BACKGROUND, hover_color=PANEL_BACKGROUND, image=settings_img,font=(FONT_FAMILY[0], 13),width=10, corner_radius=5, command=self.toggle_settings_view)
