...
class Panel(ctk.CTkFrame):
        def __init__(self, master):
            super().__init__(master,fg_color=self.SETTINGS["BACKGROUND"], border_width=BORDER_WIDTH, border_color=BORDER_COLOR, corner_radius=BORDER_RADIUS)
...
class LangPack:
    def __init__(self, master, col, row, title, subtitles, parent):
        self.frame = ctk.CTkFrame(master, fg_color=self.SETTINGS["BACKGROUND"], border_color=BORDER_COLOR, border_width=BORDER_WIDTH, corner_radius=BORDER_RADIUS)
