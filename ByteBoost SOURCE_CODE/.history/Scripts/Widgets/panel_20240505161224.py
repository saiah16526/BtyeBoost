...
class Panel(ctk.CTkFrame):
        def __init__(self, master):
            ...
            self.settings_button = ctk.CTkButton(self, text="",fg_color=self.SETTINGS["BACKGROUND"], hover_color=self.SETTINGS["BACKGROUND"], image=settings_img,font=(FONT_FAMILY[0], 13),width=10, corner_radius=5, command=self.toggle_settings_view)
