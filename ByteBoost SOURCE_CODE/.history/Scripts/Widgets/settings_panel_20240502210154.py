...
class Settings(ctk.CTkFrame):
    def __init__(self, master):
        ...
        ctk.CTkComboBox(self, values=["English", "French", "Kiswahili"],dropdown_fg_color=border_color ,border_width=0,fg_color=border_color,corner_radius=2).place(relx=0.2, rely=0.01)