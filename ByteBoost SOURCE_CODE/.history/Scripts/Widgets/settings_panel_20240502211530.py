...
class Settings(ctk.CTkFrame):
    def __init__(self, master):
        ...
        Input(self, "TEXT COLOR:", pos=(0.04, 0.1))
...
class Input():
    def __init__(self, master, text, pos):
        ...
        ctk.CTkEntry(master,textvariable=self.entry ,width=90,border_width=0,corner_radius=3).place(relx=self.x * 20, rely=self.y)