...
class Settings(ctk.CTkFrame):
    def __init__(self, master):
        ...
        Input(self, "PROGRESS_THEME:", pos=(0.31, 0.19), offset=(-0.07))
        
        ctk.CTkLabel(self, text="SYSTEM :", text_color=font_color, font=(font_family[0], 18)).place(relx=0.01, rely=0.35)
