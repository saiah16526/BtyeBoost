...
class Lessons_panel():
    def __init__(self, master):
        ...
        ctk.CTkLabel(add_frame, text=f"{("Category").upper()}", font=(font_family[0], 13)).place(relx=0.01, rely=0.13)
        category = ctk.CTkComboBox(add_frame)
        category.place(relx=0.1, rely=0.13)
