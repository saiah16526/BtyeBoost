...
class Settings(ctk.CTkFrame):
    def __init__(self, master):
        ...
        close_btn = ctk.CTkButton(master, text="CLOSE",corner_radius=0, font=(font_family[0], 13), command=lambda: close_panel(self))
        close_btn.place(relx=0.83, rely=0.18, relwidth=0.05)
        ...
        def add_lesson():
            ...
            if new_lesson.get() != "":
                ...
                with open("./SaveFiles/Lessons.json", "+r") as file:
                    ...
                    category_dict.update({title : temp}, category_dict[title])
