...
class File_panel():
    ...
    def create_import_frame(self, main_frame):
        ...
        ctk.CTkLabel(import_frame, text=f"{("Wanna DELETE something 😢").title()}", font=(font_family[2], 13)).place(relx=0.01, rely=0.01)
    ...
    def create_export_frame(self, main_frame):
        ...
        ctk.CTkLabel(export_frame, text=f"{("Wanna DELETE something 😢").title()}", font=(font_family[2], 13)).place(relx=0.01, rely=0.01)
