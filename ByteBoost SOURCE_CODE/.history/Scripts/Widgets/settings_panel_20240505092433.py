...
class File_panel():
    ...
    def create_import_frame(self, main_frame):
        ...
        settings_btn = ctk.CTkButton(import_frame, text="SETTINGS", corner_radius=0, font=(font_family[0], 20))
        settings_btn.place(relx=0.01, rely=0.98, relwidth=(1/4), relheight=(1/4), anchor="sw")
        settings_btn.propagate(flag=False)
