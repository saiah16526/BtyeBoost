...
class File_panel():
    ...
    def create_import_frame(self, main_frame):
        ...
        settings_btn = Btn(import_frame, 0.01)
        settings_btn = Btn(import_frame, (1/3) + 0.01)
        settings_btn = Btn(import_frame, (2/3) + 0.01)
        
        class Btn():
            def __init__(self, master, x):
                btn = ctk.CTkButton(import_frame, text="SETTINGS", corner_radius=0, font=(font_family[0], 20))
