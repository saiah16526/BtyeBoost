    ...
    def create_import_frame(self, main_frame):
        ...
        class Btn():
            def __init__(self, master,text, x):
                ...
                btn.place(relx=x, rely=0.9, relwidth=(1/3), relheight=(3/4), anchor="sw")
                
        settings_btn = Btn(import_frame,"SETTINGS", 0.005)
        lessons_btn = Btn(import_frame,"LESSONS", (1/3) + 0.005)
        stats_btn = Btn(import_frame,"STATISTICS", (2/3) + 0.005)
