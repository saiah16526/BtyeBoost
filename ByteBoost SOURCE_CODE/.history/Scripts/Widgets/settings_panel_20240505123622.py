...
class Settings(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.close_btn = ctk.CTkButton(master,fg_color=border_color ,height=10,text="",image=close_img,corner_radius=3,compound="top" ,font=(font_family[0], 13), command=lambda: close_panel(self))
    ...
    def create_buttons(self, master, text, frame = None, **kwargs):
        self.theme_btn = ctk.CTkButton(master,corner_radius=0, text=text, font=(font_family[0], 20), command=lambda: self.bring_frame_to_front(frame.main_frame), **kwargs)
