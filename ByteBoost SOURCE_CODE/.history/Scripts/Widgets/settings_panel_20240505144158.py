...
class Theme_panel():
    ...
    class Theme_wrapper():
        def __init__(self, master,text, x):
            ...
            frame = ctk.CTkFrame(master, fg_color="transparent", border_width=BORDER_WIDTH, corner_radius=BORDER_RADIUS, border_color=BORDER_COLOR)
            ...
            ctk.CTkRadioButton(
                ...
                value=text,
            ).pack(fill="x", pady=5,padx=2,side="bottom")
