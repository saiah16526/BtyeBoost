...
class Theme_panel():
    def __init__(self, master):
        ...
        self.Theme_wrapper(self.main_frame,"theme", 0.005, self.selected)
        self.Theme_wrapper(self.main_frame,"theme", (1/2), self.selected)
        
    class Theme_wrapper():
        def __init__(self, master,text, x, variable):
            ...
            ctk.CTkRadioButton(
                ...
                variable=variable,
                value=text,
            ).pack(fill="x", pady=3,padx=2,side="bottom")
