...
class Settings(ctk.CTkFrame):
    def __init__(self, master):
        super().__init__(master, fg_color=BACKGROUND, border_width=BORDER_WIDTH, corner_radius=BORDER_RADIUS, border_color=BORDER_COLOR)
        ...
        self.close_btn = ctk.CTkButton(master,fg_color=BORDER_COLOR ,height=10,text="",image=close_img,corner_radius=3 ,font=(FONT_FAMILY[0], 13), command=lambda: self.close_panel(self))
