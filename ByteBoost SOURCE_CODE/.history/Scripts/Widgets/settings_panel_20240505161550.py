...
class Settings(ctk.CTkFrame):
    ...
    def create_buttons(self, master, text, frame = None, **kwargs):
        self.theme_btn = ctk.CTkButton(master,fg_color=self.SETTINGS["BORDER_COLOR"],corner_radius=0, text=text, compound="top",font=(self.SETTINGS["FONT_FAMILY"][0], 13), command=lambda: self.bring_frame_to_front(frame.main_frame), **kwargs)
...
class Theme_panel():
    def __init__(self, master):
        ...
        self.main_frame.place(relx=(1/4), rely=0.01, relwidth=(3/4)-0.01, relheight=0.98)
        self.parent = master
        def theme_wrapper(master, x, details):
            ...
            def refresh_theme():
                with open("./Settings/settings.json", '+r') as file:
                    ...
                    settings_dict["self.SETTINGS["BORDER_COLOR"]"] = border_color
                    settings_dict["self.SETTINGS["BACKGROUND"]"] = background
                    settings_dict["PERCENTAGE_self.SETTINGS["BACKGROUND"]"] = percentage_bg
        ...
        theme_wrapper(self.main_frame, 0.005, ("#88aa77", "#111", "#666666", "#ccc"))
        theme_wrapper(self.main_frame, (1/2), ("#ccc", "#201", "#6ac", "#4fa"))
