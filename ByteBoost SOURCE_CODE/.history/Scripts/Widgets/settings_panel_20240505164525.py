...
class Settings(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.close_btn = ctk.CTkButton(master,fg_color=self.SETTINGS["BORDER_COLOR"] ,height=10,text="",image=close_img,corner_radius=3 ,font=(self.SETTINGS["FONT_FAMILY"][0], 13), command=lambda: self.close_panel())
