...
class Settings(ctk.CTkFrame):
    ...
    def create_buttons(self, master, text, frame = None, **kwargs):
        self.theme_btn = ctk.CTkButton(master,fg_color=self.SETTINGS["BORDER_COLOR"],text_color=self.SETTINGS["BACKGROUND"],corner_radius=0, text=text, compound="top",font=(self.SETTINGS["FONT_FAMILY"][0], 13), command=lambda: self.bring_frame_to_front(frame.main_frame), **kwargs)
