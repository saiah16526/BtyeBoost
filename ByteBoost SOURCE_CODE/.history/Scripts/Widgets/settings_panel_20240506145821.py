...
class Theme_panel():
    def __init__(self, master):
        ...
        self.main_frame.place(relx=(1/4), rely=0.01, relwidth=(3/4)-0.01, relheight=0.98)
        self.parent = master
        def theme_wrapper(master, x, y,details):
        ...
        theme_wrapper(self.main_frame, 0.005, 0.01,("#D6B7A3", "#5C3D31", "#CCCCCC", "#3F9D9D"))
        theme_wrapper(self.main_frame, (1/2),0.01, ("#121212", "#F5E1DA", "#D6B7A3", "#B56545"))
        theme_wrapper(self.main_frame, (1/2),0.46, ("#FFFFFF", "#121212", "#242424", "#1976D2"))
