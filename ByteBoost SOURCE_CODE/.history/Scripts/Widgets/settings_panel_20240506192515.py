...
class Lessons_panel():
    ...
    def create_add_frame(self, main_frame):
        ...
        ctk.CTkLabel(add_frame, text=f"{("Wanna Add a new Lesson to track").title()}", font=(self.SETTINGS["FONT_FAMILY"][2], 13)).place(relx=0.01, rely=0.01)
    ...
    def create_del_frame(self, main_frame):
        ...
        ctk.CTkLabel(del_frame, text=f"{("Wanna DELETE something 😢").title()}", font=(self.SETTINGS["FONT_FAMILY"][2], 13)).place(relx=0.01, rely=0.01)
