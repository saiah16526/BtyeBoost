...
class Settings(ctk.CTkFrame):
    def __init__(self, master):
        ...
        theme_img = ImageTk.PhotoImage(Image.open(resource_path("./Images/Icons/theme.png")).resize((50, 50)))
...
class Theme_panel():
    def __init__(self, master):
        ...
        theme_wrapper(self.main_frame, 0.005, 0.01,("#D6B7A3", "#5C3D31", "#CCCCCC", "#3F9D9D"), "./Images/theme_1.png")
        theme_wrapper(self.main_frame, (1/2),0.01, ("#121212", "#D6B7A3", "#B52f45", "#B56545"), "./Images/theme_3.png")
        theme_wrapper(self.main_frame, (1/2),0.46, ("#FFFFFF", "#121212", "#242424", "#1976D2"), "./Images/theme_2.png")
