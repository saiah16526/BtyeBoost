...
class TimerFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        record = ctk.CTkLabel(self, text_color=font_color, text="Record to beat: 1:45", font=(font, 14), anchor="w")
        record.place(relx=0.42, rely=0.1)

        ctk.CTkLabel(self, text_color=font_color, text="Selected Lesson:", font=(font, 14), anchor="w").place(relx=0.42, rely=0.23)
        ...
        label_input = ctk.CTkLabel(self, text_color=border, text="Desired Duration:", font=(font, 14), anchor="w")
    ...
    def stop_timer(self):
        if self.timer_running or self.timer_paused:
            ...
            self.master.test3.destroy()
            self.master.test3 = StatsWrapper(self.master)
            self.timer_running = False
