...
class TimerFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        ctk.CTkLabel(self, text_color="#666666", textvariable=self.lang, font=(FONT_FAMILY[2], 14), anchor="w").place(relx=0.42, rely=0.35)
        ctk.CTkLabel(self, text_color=FONT_COLOR, text="Desired Duration:", font=(FONT_FAMILY[2], 14), anchor="w").place(relx=0.42, rely=0.52)

        self.entry_value = ctk.StringVar(value="Qt")
