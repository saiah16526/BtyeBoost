...
class TimerFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        #Images
        start_img = ImageTk.PhotoImage(file="./Images/Icons/start.png")
        # Buttons
        ctk.CTkButton(self, corner_radius=3,image=start_img ,text="Start", command=self.start_timer).place(relx=0.5, rely=0.75, relwidth=0.1)
