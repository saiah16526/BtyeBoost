...
class TimerFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        ctk.CTkButton(self, corner_radius=3, text="Pause", command=self.pause_timer).place(relx=0.65, rely=0.65, relwidth=0.1)
        ctk.CTkButton(self, corner_radius=3, text="Stop", command=self.stop_timer).place(relx=0.8, rely=0.65, relwidth=0.1)
