...
class TimerFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        # Buttons
        ctk.CTkButton(self, corner_radius=3,image=start_img ,text="", command=self.start_timer, fg_color=TIMER_BACKGROUND).place(relx=0.5, rely=0.65, relwidth=0.14)
        ctk.CTkButton(self, corner_radius=3, image=pause_img ,text="", command=self.pause_timer,fg_color=TIMER_BACKGROUND).place(relx=0.69, rely=0.65, relwidth=0.14)
        ctk.CTkButton(self, corner_radius=3, image=reset_img ,text="", command=self.stop_timer,fg_color=TIMER_BACKGROUND).place(relx=0.84, rely=0.65, relwidth=0.14)
