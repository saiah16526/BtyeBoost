...
class TimerFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        # Progress Canvas
        self.progress_canvas = ctk.CTkCanvas(self, background=BACKGROUND, bd=0, highlightthickness=0)
        ...
        ctk.CTkLabel(self, text_color="#666666", textvariable=self.lang, font=(FONT_FAMILY[2], 14), anchor="w").place(relx=0.42, rely=0.37)
        ...
        # Buttons
        ctk.CTkButton(self, corner_radius=3,image=start_img ,text="", command=self.start_timer, hover_color=BACKGROUND,fg_color=BACKGROUND).place(relx=0.5, rely=0.65, relwidth=0.14)
        ctk.CTkButton(self, corner_radius=3, image=pause_img ,text="", command=self.pause_timer,hover_color=BACKGROUND,fg_color=BACKGROUND).place(relx=0.69, rely=0.65, relwidth=0.14)
        ctk.CTkButton(self, corner_radius=3, image=reset_img ,text="", command=self.stop_timer,hover_color=BACKGROUND,fg_color=BACKGROUND).place(relx=0.84, rely=0.65, relwidth=0.14)
