...
class TimerFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        # Clock Label
        self.clock = ctk.CTkLabel(self, text_color=self.SETTINGS["self.SETTINGS["BORDER_COLOR"]"], text="0:00", font=("JetBrains Mono", 40), anchor="w")
        self.clock.place(relx=0.11, rely=0.35)

        # Other Labels and Entry
        ctk.CTkLabel(self, text_color=self.SETTINGS["self.SETTINGS["BORDER_COLOR"]"], text="Record to beat: 1:45", font=(self.SETTINGS["FONT_FAMILY"][2], 14), anchor="w").place(relx=0.42, rely=0.1)
        ctk.CTkLabel(self, text_color=self.SETTINGS["self.SETTINGS["BORDER_COLOR"]"], text="Selected Lesson:", font=(self.SETTINGS["FONT_FAMILY"][2], 14), anchor="w").place(relx=0.42, rely=0.23)
