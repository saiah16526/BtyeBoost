...
class TimerFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        ctk.CTkLabel(self, text_color=self.SETTINGS["PERCENTAGE_BACKGROUND"], textvariable=self.lang, font=(self.SETTINGS["FONT_FAMILY"][2], 14), anchor="w").place(relx=0.42, rely=0.37)
