...
class TransparentWidget:
    def __init__(self, parent, widget_type, image_path, transparent_color="white", **kwargs):
        """
...
if __name__ == "__main__":
    ...
    transparent_label = TransparentWidget(root, ctk.CTkLabel, image_path, transparent_color, fg_color="white")
